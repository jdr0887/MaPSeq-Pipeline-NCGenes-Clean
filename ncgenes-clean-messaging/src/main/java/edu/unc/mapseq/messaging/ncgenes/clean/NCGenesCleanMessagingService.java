...
public class NCGenesCleanMessagingService {

    private final Logger logger = LoggerFactory.getLogger(NCGenesCleanMessagingService.class);
    ...
    public NCGenesCleanMessagingService() {
        super();
    }
