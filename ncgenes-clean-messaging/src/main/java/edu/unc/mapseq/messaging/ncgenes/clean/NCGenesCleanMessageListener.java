...
public class NCGenesCleanMessageListener implements MessageListener {
    ...
    public NCGenesCleanMessageListener() {
        super();
    }
            ...
            for (int i = 0; i < entityArray.length(); ++i) {
                ...
                if (entityJSONObject.has("entity_type")) {
                    ...
                    if (WorkflowRun.class.getSimpleName().equals(entityType)) {
                        workflowRun = EntityUtil.getWorkflowRun(pipelineBeanService.getMaPSeqDAOBean(), "NCGenesClean",
